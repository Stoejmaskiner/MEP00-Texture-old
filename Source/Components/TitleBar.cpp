...
//==============================================================================
TitleBar::TitleBar(stoej::ThemedAPVTS& apvts) : stoej::FloatComponent<juce::Component>(apvts)
{
...
void TitleBar::paint (juce::Graphics& g)
{
    ...
    */
    ...
    auto txt_c_1 = this->apvts_.getGenericThemeColorWithModeApplied(stoej::strings::generic_theme::text_primary);
    auto txt_c_2 = this->apvts_.getGenericThemeColorWithModeApplied(stoej::strings::generic_theme::text_secondary);
